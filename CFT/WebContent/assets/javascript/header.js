...
headerHTML += '<FONT color="#424242" size="4">.CommunicationFamliyTool<button id = "head-button" class="btn btn-primary col-sm-2" onClick="recStart()">rec</button><br></FONT></TD></TR>';
