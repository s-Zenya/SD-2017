//header.js ヘッダーのロゴを/Loginに遷移するように加筆
//headerLogin.js ログインがめんなどでは遷移しないよう修正
...
headerHTML += '<TD id="rec-button" border="0" bgcolor="#111" cellspacing="0" cellpadding="0" height="50"><button id = "head-button" class="btn btn-primary col-sm-12" onClick="recStart()">音声入力</button></TD>';
